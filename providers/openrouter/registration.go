...
const OrderPriority = 50

// IntentAliases maps intent aliases to wire model IDs for this provider.
var IntentAliases = map[string]string{
	llmproviders.IntentFast:     ModelClaude35Haiku,
	llmproviders.IntentDefault:  ModelClaude37Sonnet,
	llmproviders.IntentPowerful: ModelClaudeOpus4,
}

// Register is the registration for the OpenRouter provider.
